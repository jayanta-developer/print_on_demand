...
export default function VisionAndGoal() {
    ...
    <>
      <Box className="reflectionContainer">
        <Box className="reflectionSideMenu">
          <Typography className='VisionAndGoalHeader'>Title</Typography>
          ...
          <Box mb={2} className="VisionAndGoalRadioBox">
          ...
          <Box className="VisionAndGoalBtnBox">
