...
import TopRightImageC from "../../../Assets/images/TopRight.png"
import TopLeftImageC from "../../../Assets/images/TopLeftImageC.png"
import BottomImageC from "../../../Assets/images/BottomRightC.png"
...
export default function Layout() {
  ...
  const [rightCustomBox, setRightCustomBox] = useState("")
  const [leftCustomBox, setLeftCustomBox] = useState(false)
  const [customOption, setCustomOption] = useState();
  const [customOptionVal, setCustomOptionVal] = useState();

  const [topLeftTab, setTopLeftTab] = useState("")
  const [topLeftCustomText, setTopLeftCustomText] = useState("")

  const [topRightTab, setTopRightTab] = useState("")
  const [topRightCustomText, setTopRightCustomText] = useState("")
  ...
  const handleCustomTopLeftRadioChange = (event) => {
    setTopLeftTab(event.target.value);
  };
  const handleCustomTopRightRadioChange = (event) => {
    setTopRightTab(event.target.value);
  };
  const handleCustomRightBottomRadioChange = (event) => {
    setBottomRightTab(event.target.value);
  };

  const TopLeftOnSelectChang = () => {
    let text;
    switch (topLeftTab) {
      default:
        text = "JUNE 26-JULY 2";
        break;
      case "ReflectionandGratitude":
        text = "Reflection and Gratitude";
        break;
      case "QuoteOnly":
        text = "QuoteOnly";
        break;
      ...
      case "WellBeing":
        text = "WellBeing"
        break;
      case "ReflectionandGratitudeQuote":
        text = "Reflection and Gratitude"
        break;
      case "Family":
        text = "Family"
      ...
      case "Blank":
        ...
        break;
      case "CustomList":
        text = topLeftCustomText
        break;
      case "CustomChecklist":
        text = "Custom Check list"
        break;
      case "Custombox":
        text = "Custombox"
        break;
    }
    return <Typography className='TopLeftDText'>{text}</Typography>;
  }
  const TopRightOnSelectChang = () => {
    let text;
    switch (topRightTab) {
      default:
        text = "";
  ...
  const BottomRightOnSelectChang = () => {
    let text;
    ...
    return <Typography className='BottomRightDText'>{text}</Typography>;
  }
  useEffect(() => {
        ...
        <Box className="DailySinglePage">
          <Box className="sideCustomBox">
            ...
            <Box sx={{ display: timeTab === "Hourlytimes" ? "block" : "none" }} className="sideChangeableTab">
              ...
              {/* Custom Top right page */}
              <Box mb={2} className={rightCustomBox === "TopRight" ? "customPageBottomBox" : "customPageBottomBox customPageBottomRCloseBox"}>
                <img onClick={() => setRightCustomBox(rightCustomBox === "TopRight" ? null : "TopRight")} className='leftCustomArrow' src={rightCustomBox === "TopRight" ? UpArrow : DownArrow} />
                <Box mb={rightCustomBox === "TopRight" ? 0 : 5} className="customPageBoxHeader">
                  <Typography onClick={() => setRightCustomBox(rightCustomBox === "TopRight" ? null : "TopRight")} className='BoxHeaderText'>Top right custom option
                ...
                <Box className="customRadioBox">
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        checked={topRightTab === 'ReflectionandGratitude'}
                        onChange={handleCustomTopRightRadioChange}
                      />
                    </label>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='HabitTracker'
                        value='HabitTracker'
                        checked={topRightTab === 'HabitTracker'}
                        onChange={handleCustomTopRightRadioChange}
                      />
                    </label>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        checked={topRightTab === 'ReflectionandGratitudeQuote'}
                        onChange={handleCustomTopRightRadioChange}
                      />
                    </label>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='CustomList'
                        value='CustomList'
                        checked={topRightTab === 'CustomList'}
                        onChange={handleCustomTopRightRadioChange}
                      />
                    </label>
                  ...
                  <Box className="customRadioInputBoxInput">
                    <input type="text" placeholder='Title' value={topRightCustomText} onChange={(e) => setTopRightCustomText(e.target.value)} />
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        checked={topRightTab === 'CustomChecklist'}
                        onChange={handleCustomTopRightRadioChange}
                      />
                    </label>
              ...
              {/* Custom Top Left page */}
              <Box mb={2} className={rightCustomBox === "TopLeft" ? "customPageBottomBox" : "customPageBottomBox customPageBottomRCloseBox"}>
                <img onClick={() => setRightCustomBox(rightCustomBox === "TopLeft" ? null : "TopLeft")} className='leftCustomArrow' src={rightCustomBox === "TopLeft" ? UpArrow : DownArrow} />
                <Box mb={rightCustomBox === "TopLeft" ? 0 : 5} className="customPageBoxHeader">
                  <Typography onClick={() => setRightCustomBox(rightCustomBox === "TopLeft" ? null : "TopLeft")} className='BoxHeaderText'>Top left custom option
                    <span className='choseOneSubText'>(choose one)</span>
                ...
                <Box className="customRadioBox">
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='ReflectionandGratitude'
                        value='ReflectionandGratitude'
                        checked={topLeftTab === 'ReflectionandGratitude'}
                        onChange={handleCustomTopLeftRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Reflection and Gratitude</Typography>
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='HabitTracker'
                        value='HabitTracker'
                        checked={topLeftTab === 'HabitTracker'}
                        onChange={handleCustomTopLeftRadioChange}
                      />
                    </label>
                    <Typography mr={2} >Habit Tracker</Typography>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='ReflectionandGratitudeQuote'
                        value='ReflectionandGratitudeQuote'
                        checked={topLeftTab === 'ReflectionandGratitudeQuote'}
                        onChange={handleCustomTopLeftRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Reflection and Gratitude with a Quote</Typography>
                  ...
                  <Box className="customRadioInputBoxInput">
                    <input value={topLeftCustomText} type="text" placeholder='Title' onChange={(e) => setTopLeftCustomText(e.target.value)} />
                    <Box className="titleSaveButton">
                      <Typography>Save</Typography>
                    </Box>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='CustomChecklist'
                        value='CustomChecklist'
                        checked={topLeftTab === 'CustomChecklist'}
                        onChange={handleCustomTopLeftRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Custom Checklist</Typography>
              ...
              <Box mb={2} className={rightCustomBox === "BottomRight" ? "customPageBottomBox" : "customPageBottomBox customPageBottomRCloseBox"}>
                <img onClick={() => setRightCustomBox(rightCustomBox === "BottomRight" ? null : "BottomRight")} className='leftCustomArrow' src={rightCustomBox === "BottomRight" ? UpArrow : DownArrow} />
                <Box mb={rightCustomBox === "BottomRight" ? 0 : 5} className="customPageBoxHeader">
                  <Typography onClick={() => setRightCustomBox(rightCustomBox === "BottomRight" ? null : "BottomRight")} className='BoxHeaderText'>Bottom right custom option
                    <span className='choseOneSubText'>(choose one)</span>
                  </Typography>
                </Box>
                <Box className="customRadioBox">
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='ReflectionandGratitude'
                        value='ReflectionandGratitude'
                        checked={BottomRightTab === 'ReflectionandGratitude'}
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='QuoteOnly'
                        value='QuoteOnly'
                        checked={BottomRightTab === 'QuoteOnly'}
                        onChange={handleCustomRightBottomRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Quote Only</Typography>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='HabitTracker'
                        value='HabitTracker'
                        checked={BottomRightTab === 'HabitTracker'}
                        onChange={handleCustomRightBottomRadioChange}
                      />
                    </label>
                    <Typography mr={2} >Habit Tracker</Typography>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='WellBeing'
                        value='WellBeing'
                        checked={BottomRightTab === 'WellBeing'}
                        onChange={handleCustomRightBottomRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Well-Being</Typography>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='ReflectionandGratitudeQuote'
                        value='ReflectionandGratitudeQuote'
                        checked={BottomRightTab === 'ReflectionandGratitudeQuote'}
                        onChange={handleCustomRightBottomRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Reflection and Gratitude with a Quote</Typography>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='CustomList'
                        value='CustomList'
                        checked={BottomRightTab === 'CustomList'}
                        onChange={handleCustomRightBottomRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Custom List</Typography>
                  ...
                  <Box className="customRadioInputBoxInput">
                    <input type="text" placeholder='Title' value={bottomRightCustomText} onChange={(e) => setBottomRightCustomText(e.target.value)} />
                    <Box className="titleSaveButton">
                      <Typography>Save</Typography>
                    </Box>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='CustomChecklist'
                        value='CustomChecklist'
                        checked={BottomRightTab === 'CustomChecklist'}
                        onChange={handleCustomRightBottomRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Custom Checklist</Typography>
                  ...
                  <Box className="customRadioInputBox">
                    <label className='radioLabel' >
                      <Radio
                        ...
                        name='Custombox'
                        value='Custombox'
                        checked={BottomRightTab === 'Custombox'}
                        onChange={handleCustomRightBottomRadioChange}
                      />
                    </label>
                    <Typography mr={2}>Custom box</Typography>
              ...
              <Box className={leftCustomBox === "BottomLeft" ? "customPageBottomBox" : "customPageBottomBox customPageBottomLCloseBox"}>
                <img onClick={() => setLeftCustomBox(leftCustomBox === "BottomLeft" ? null : "BottomLeft")} className='leftCustomArrow' src={leftCustomBox === "BottomLeft" ? UpArrow : DownArrow} />
                <Box mb={leftCustomBox === "BottomLeft" ? 0 : 5} className="customPageBoxHeader">
                  <Typography onClick={() => setLeftCustomBox(leftCustomBox === "BottomLeft" ? null : "BottomLeft")} className='BoxHeaderText'>Bottom left custom option<span className='choseOneSubText'>(choose one)</span></Typography>
              ...
              <Box className="st3CoverBox">
                <Box mr={1} className="st3page">
                  ...
                  <Box className="TopLeft">
                    <img className='PageSubImages' src={TopLeftImageC} />
                    {TopLeftOnSelectChang()}
                  </Box>

                  <Box className="TopRight">
                    <img className='PageSubImages' src={TopRightImageC} />
                    {TopRightOnSelectChang()}
                  </Box>

                  <Box className="BottomRight">
                    <img className='PageSubImages' src={BottomImageC} />
                    {BottomRightOnSelectChang()}
                  </Box>
