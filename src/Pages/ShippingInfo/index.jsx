...
export default function ShippingInfo() {
  ...
  const [cityDropVal, setCityDropVal] = useState("")
        ...
        <Box className="cartBox">
          ...
          <Box className="cartItemBox">
            <Box mb={1.5} className="shipInputBox">
              <TextField className='Ffour' placeholder='name' />
              <TextField className='Ffour' placeholder='email@email.com' />
            </Box>
            <Box mb={1.5} className="shipInputBox">
              <TextField className='Ffour' placeholder='GUn st' />
              <TextField className='Ffour' placeholder='Ste, apt, etc' />
            </Box>
            <Box mb={1.5} className="shipInputBox">
              <TextField className='Ffour' placeholder='New York' />
              <TextField className='cityInput' placeholder='City' value={cityDropVal} />
              <ArrowDropDownIcon onClick={() => setCityDrop(!cityDrop)} className='cityDropArrow' />
              <Box sx={{ height: cityDrop ? "auto" : "0px" }} className="stateDrop">
                <Box onClick={(e) => {
                  setCityDrop(false)
                  setCityDropVal(e.target.innerText)
              ...
              <TextField className='cityInput' placeholder='90001' />
            </Box>
            <Box mb={1.5} className="shipInputDropBox">
              <TextField className='stateInput' placeholder='90001' type='dropDown' value={stateDropVal} />
              <ArrowDropDownIcon onClick={() => setStateDrop(!stateDrop)} className='StateDropArrow' />
              <Box sx={{ height: stateDrop ? "auto" : "0px" }} className="stateDrop">
                <Box onClick={(e) => {
                  setStateDrop(false)
          ...
          <ButtonPrimary buttonText="CONTINUE TO BILLING" />
          ...
          <Box className="paymentSummeryBox">
            <Box className="paymentSummeryItem">
              ...
              <Typography className='paymentSummeryText'>$6.50</Typography>
            </Box>
            <Box className="paymentSummeryItem">
              <Typography className='paymentSummeryText'>TAX</Typography>
              <Typography className='paymentSummeryText'>$0.50</Typography>
            </Box>
            <Box className="paymentSummeryItem">
              <Typography className='paymentSummeryText'>SHIPPING</Typography>
              <Typography className='paymentSummeryText'>$5.00</Typography>
            </Box>
            <Box className="paymentSummeryItem">
              <Typography className='paymentSummeryTotalText'>TOTAL</Typography>
              <Typography className='paymentSummeryTotalText'>$12.05 USD</Typography>
            </Box>
          </Box>

          <Box className="couponCodeBox">
            <TextField placeholder='Add Coupon Code' />
            <Box className="couponButton">
